...
(function (e, undefined) {
  ...
  function F() {
    window["Object"].defineProperty(this.cache = {}, 0, {
      "get": function () {
        return {};
      }
    }), this.expando = x.expando + window["Math"].random();
    // console.log(this);
    // debugger;
  }
  ...
  function P(e, t, n) {
    ...
    if (n === undefined && 1 === e.nodeType) {
      if (r = "data-" + t.replace(O, "-$1").toLowerCase(), n = e.getAttribute(r), "string" == typeof n) {
        try {
          n = "true" === n ? !0 : "false" === n ? !1 : "null" === n ? null : +n + "" === n ? +n : H.test(n) ? window["JSON"].parse(n) : n;
        } catch (i) {}
        L.set(e, t, n);
      } else {
        n = undefined;
  ...
  function Ot(e, t, n) {
    var r = Tt.exec(t);
    return r ? window["Math"].max(0, r[1] - (n || 0)) + (r[2] || "px") : t;
  }
  ...
  function Pt(e, t, n) {
    ...
    if (0 >= i || null == i) {
      ...
      r = s && (x.support.boxSizingReliable || i === e.style[t]), i = window["parseFloat"](i) || 0;
    }
  ...
  function jn(e, t, n) {
    var r,
      ...
      u = function () {
        ...
        var t = xn || En(),
          n = window["Math"].max(0, l.startTime + l.duration - t),
          r = n / l.duration || 0,
          o = 1 - r,
          s = 0,
          u = l.tweens.length;
  ...
  var t,
    ...
    b = new window["RegExp"]("[+-]?(?:\\d*\\.|)\\d+(?:[eE][+-]?\\d+|)", "").source,
    w = new window["RegExp"]("\\S+", "g"),
    T = new window["RegExp"]("^(?:\\s*(<[\\w\\W]+>)[^>]*|#([\\w-]*))$", ""),
    C = new window["RegExp"]("^<(\\w+)\\s*\\/?>(?:<\\/\\1>|)$", ""),
    k = new window["RegExp"]("^-ms-", ""),
    N = new window["RegExp"]("-([\\da-z])", "gi"),
    E = function (e, t) {
  ...
  x.fn = x.prototype = {
    ...
    "expando": "jQuery" + (p + window["Math"].random()).replace(new window["RegExp"]("\\D", "g"), ""),
    ...
    "isNumeric": function (e) {
      return !window["isNaN"](window["parseFloat"](e)) && window["isFinite"](e);
    },
    "type": function (e) {
    ...
    "makeArray": function (e, t) {
      var n = t || [];
      return null != e && (j(window["Object"](e)) ? x.merge(n, "string" == typeof e ? [e] : e) : h.call(n, e)), n;
    },
    ...
    return n || (n = x.Deferred(), "complete" === o.readyState ? window["setTimeout"](x.ready) : (o.addEventListener("DOMContentLoaded", S, !1), e.addEventListener("load", S, !1))), n.promise(t);
  ...
  t = x(o), function (e, undefined) {
      ...
      var n = 0,
        ...
        a = function (a, l, c, f, h) {
          var d,
            ...
            N = w += null == C ? 1 : window["Math"].random() || .1;
    ...
    var t,
      ...
      B = "\\[" + M + "*(" + W + ")" + M + "*(?:([*^$|!~]?=)" + M + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + $ + ")|)|)" + M + "*\\]",
      I = ":(" + W + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + B.replace(3, 8) + ")*)|.*)\\)|)",
      z = window["RegExp"]("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$", "g"),
      _ = window["RegExp"]("^" + M + "*," + M + "*"),
      X = window["RegExp"]("^" + M + "*([>+~]|" + M + ")" + M + "*"),
      U = window["RegExp"](M + "*[+~]"),
      Y = window["RegExp"]("=" + M + "*([^\\]'\"]*)" + M + "*\\]", "g"),
      V = window["RegExp"](I),
      G = window["RegExp"]("^" + $ + "$"),
      J = {
        "ID": window["RegExp"]("^#(" + W + ")"),
        "CLASS": window["RegExp"]("^\\.(" + W + ")"),
        "TAG": window["RegExp"]("^(" + W.replace("w", "w*") + ")"),
        "ATTR": window["RegExp"]("^" + B),
        "PSEUDO": window["RegExp"]("^" + I),
        "CHILD": window["RegExp"]("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + M + "*(even|odd|(([+-]|)(\\d*)n|)" + M + "*(?:([+-]|)" + M + "*(\\d+)|))" + M + "*\\)|)", "i"),
        "bool": window["RegExp"]("^(?:" + R + ")$", "i"),
        "needsContext": window["RegExp"]("^" + M + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + M + "*((?:-\\d)?\\d*)" + M + "*\\)|)(?=[^-]|$)", "i")
      },
      Q = new window["RegExp"]("^[^{]+\\{\\s*\\[native \\w", ""),
      K = new window["RegExp"]("^(?:#([\\w-]+)|(\\w+)|\\.([\\w-]+))$", ""),
      Z = new window["RegExp"]("^(?:input|select|textarea|button)$", "i"),
      et = new window["RegExp"]("^h\\d$", "i"),
      tt = new window["RegExp"]("'|\\\\", "g"),
      nt = window["RegExp"]("\\\\([\\da-f]{1,6}" + M + "?|(" + M + ")|.)", "ig"),
      rt = function (e, t, n) {
        var r = "0x" + t - (900 + 1469 * 44);
        return r !== r || n ? t : 0 > r ? window["String"].fromCharCode(r + (988 + 1956 * 33)) : window["String"].fromCharCode(55296 | r >> 10, 56320 | 1023 & r);
      };
    try {
    ...
    s = ot.isXML = function (e) {
      ...
      }), d = d.length && window["RegExp"](d.join("|")), g = g.length && window["RegExp"](g.join("|")), y = Q.test(f.contains) || f.compareDocumentPosition ? function (e, t) {
      ...
      throw window["Error"]("Syntax error, unrecognized expression: " + e);
      ...
      "filter": {
        ...
        "CLASS": function (e) {
          var t = C[e + " "];
          return t || (t = window["RegExp"]("(^|" + M + ")" + e + "(" + M + "|$)")) && C(e, function (e) {
  ...
  x.Callbacks = function (e) {
    ...
    "when": function (e) {
      var t = 0,
        ...
        l;
      if (r > 1) {
        for (a = window["Array"](r), u = window["Array"](r), l = window["Array"](r); r > t; t++) {
    ...
    return n.type ? (n.type = "checkbox", t.checkOn = "" !== n.value, t.optSelected = a.selected, t.reliableMarginRight = !0, t.boxSizingReliable = !0, t.pixelPosition = !1, n.checked = !0, t.noCloneChecked = n.cloneNode(!0).checked, s.disabled = !0, t.optDisabled = !a.disabled, n = o.createElement("input"), n.value = "t", n.type = "radio", t.radioValue = "t" === n.value, n.setAttribute("checked", "t"), n.setAttribute("name", "t"), r.appendChild(n), t.checkClone = r.cloneNode(!0).cloneNode(!0).lastChild.checked, t.focusinBubbles = "onfocusin" in e, i.style.backgroundClip = "content-box", i.cloneNode(!0).style.backgroundClip = "", t.clearCloneStyle = "content-box" === i.style.backgroundClip, x(function () {
      ...
      a && (n = o.createElement("div"), n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", a.appendChild(n).appendChild(i), i.innerHTML = "", i.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%", x.swap(a, null != a.style.zoom ? {
        ...
        "width": "4px"
      }).width, r = i.appendChild(o.createElement("div")), r.style.cssText = i.style.cssText = s, r.style.marginRight = r.style.width = "0", i.style.width = "1px", t.reliableMarginRight = !window["parseFloat"]((e.getComputedStyle(r, null) || {}).marginRight)), a.removeChild(n));
    }), t) : t;
  }({});
  var L,
    q,
    H = new window["RegExp"]("(?:\\{[\\s\\S]*\\}|\\[[\\s\\S]*\\])$", ""),
    O = new window["RegExp"]("([A-Z])", "g");
    ...
    "key": function (e) {
      ...
      if (!n) {
        ...
        try {
          t[this.expando] = {
            "value": n
          }, window["Object"].defineProperties(e, t);
        } catch (r) {
  ...
  var R,
    M,
    W = new window["RegExp"]("[\\t\\r\\n\\f]", "g"),
    $ = new window["RegExp"]("\\r", "g"),
    B = new window["RegExp"]("^(?:input|select|textarea|button)$", "i");
  x.fn.extend({
    "attr": function (e, t) {
  ...
  }, x.each(x.expr.match.bool.source.match(new window["RegExp"]("\\w+", "g")), function (e, t) {
  ...
  var I = new window["RegExp"]("^key", ""),
    z = new window["RegExp"]("^(?:mouse|contextmenu)|click", ""),
    _ = new window["RegExp"]("^(?:focusinfocus|focusoutblur)$", ""),
    X = new window["RegExp"]("^([^.]*)(?:\\.(.+)|)$", "");
  x.event = {
    "global": {},
      ...
      if (m && (u = m.events)) {
        ...
        while (l--) {
          if (a = X.exec(t[l]) || [], h = g = a[1], d = (a[2] || "").split(".").sort(), h) {
            p = x.event.special[h] || {}, h = (r ? p.delegateType : p.bindType) || h, f = u[h] || [], a = a[2] && window["RegExp"]("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = f.length;
            while (o--) {
    ...
    "trigger": function (t, n, r, i) {
      ...
      if (a = u = r = r || o, 3 !== r.nodeType && 8 !== r.nodeType && !_.test(d + x.event.triggered) && (d.indexOf(".") >= 0 && (g = d.split("."), d = g.shift(), g.sort()), c = 0 > d.indexOf(":") && "on" + d, t = t[x.expando] ? t : new x.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = g.join("."), t.namespace_re = t.namespace ? window["RegExp"]("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = undefined, t.target || (t.target = r), n = null == n ? [t] : x.makeArray(n, [t]), f = x.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
  ...
  var G = new window["RegExp"]("^.[^:#\\[\\.,]*$", ""),
    J = new window["RegExp"]("^(?:parents|prev(?:Until|All))", ""),
  ...
  var tt = new window["RegExp"]("<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\\w:]+)[^>]*)\\/>", "gi"),
    nt = new window["RegExp"]("<([\\w:]+)", ""),
    rt = new window["RegExp"]("<|&#?\\w+;", ""),
    it = new window["RegExp"]("<(?:script|style|link)", "i"),
    ot = new window["RegExp"]("^(?:checkbox|radio)$", "i"),
    st = new window["RegExp"]("checked\\s*(?:[^=]|=\\s*.checked.)", "i"),
    at = new window["RegExp"]("^$|\\/(?:java|ecma)script", "i"),
    ut = new window["RegExp"]("^true\\/(.*)", ""),
    lt = new window["RegExp"]("^\\s*<!(?:\\[CDATA\\[|--)|(?:\\]\\]|--)>\\s*$", "g"),
    ct = {
    ...
    "cleanData": function (e) {
      ...
      for (; (n = e[u]) !== undefined; u++) {
        if (F.accepts(n) && (o = n[q.expando], o && (t = q.cache[o]))) {
          if (r = window["Object"].keys(t.events || {}), r.length) {
  ...
  var vt,
    xt,
    bt = new window["RegExp"]("^(none|table(?!-c[ea]).+)", ""),
    wt = new window["RegExp"]("^margin", ""),
    Tt = window["RegExp"]("^(" + b + ")(.*)$", "i"),
    Ct = window["RegExp"]("^(" + b + ")(?!px)[a-z%]+$", "i"),
    kt = window["RegExp"]("^([+-])=(" + b + ")", "i"),
    Nt = {
      "BODY": "block"
    },
    Et = {
  ...
  x.fn.extend({
    ...
    "style": function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          a = x.camelCase(t),
          u = e.style;
        return t = x.cssProps[a] || (x.cssProps[a] = At(u, a)), s = x.cssHooks[t] || x.cssHooks[a], n === undefined ? s && "get" in s && (i = s.get(e, !1, r)) !== undefined ? i : u[t] : (o = typeof n, "string" === o && (i = kt.exec(n)) && (n = (i[1] + 1) * i[2] + window["parseFloat"](x.css(e, t)), o = "number"), null == n || "number" === o && window["isNaN"](n) || ("number" !== o || x.cssNumber[a] || (n += "px"), x.support.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && (n = s.set(e, n, r)) === undefined || (u[t] = n)), undefined);
      }
    },
    "css": function (e, t, n, r) {
      var i,
        ...
        s,
        a = x.camelCase(t);
      return t = x.cssProps[a] || (x.cssProps[a] = At(e.style, a)), s = x.cssHooks[t] || x.cssHooks[a], s && "get" in s && (i = s.get(e, !0, n)), i === undefined && (i = vt(e, t, r)), "normal" === i && t in St && (i = St[t]), "" === n || n ? (o = window["parseFloat"](i), n === !0 || x.isNumeric(o) ? o || 0 : i) : i;
    }
  }), vt = function (e, t, n) {
    var r,
      i,
  ...
  var Wt = new window["RegExp"]("%20", "g"),
    $t = new window["RegExp"]("\\[\\]$", ""),
    Bt = new window["RegExp"]("\\r?\\n", "g"),
    It = new window["RegExp"]("^(?:submit|button|image|reset|file)$", "i"),
    zt = new window["RegExp"]("^(?:input|select|textarea|keygen)", "i");
  x.fn.extend({
    "serialize": function () {
    ...
    var n,
      r = [],
      i = function (e, t) {
        t = x.isFunction(t) ? t() : null == t ? "" : t, r[r.length] = window["encodeURIComponent"](e) + "=" + window["encodeURIComponent"](t);
      };
  ...
  var Xt,
    Ut,
    Yt = x.now(),
    Vt = new window["RegExp"]("\\?", ""),
    Gt = new window["RegExp"]("#.*$", ""),
    Jt = new window["RegExp"]("([?&])_=[^&]*", ""),
    Qt = new window["RegExp"]("^(.*?):[ \\t]*([^\\r\\n]*)$", "gm"),
    Kt = new window["RegExp"]("^(?:about|app|app-storage|.+-extension|file|res|widget):$", ""),
    Zt = new window["RegExp"]("^(?:GET|HEAD)$", ""),
    en = new window["RegExp"]("^\\/\\/", ""),
    tn = new window["RegExp"]("^([\\w.+-]+:)(?:\\/\\/([^\\/?#:]*)(?::(\\d+)|)|)", ""),
    nn = x.fn.load,
    rn = {},
    on = {},
    sn = "*/".concat("*");
  ...
  x.fn.load = function (e, t, n) {
    ...
    "ajaxSettings": {
      ...
      "contents": {
        "xml": new window["RegExp"]("xml", ""),
        "html": new window["RegExp"]("html", ""),
        "json": new window["RegExp"]("json", "")
      },
      "responseFields": {
        "xml": "responseXML",
        "text": "responseText",
    ...
    "ajax": function (e, t) {
      function k(e, t, o, a) {
        var l,
          ...
          w,
          C = t;
        2 !== v && (v = 2, s && window["clearTimeout"](s), n = undefined, i = a || "", T.readyState = e > 0 ? 4 : 0, l = e >= 200 && 300 > e || 304 === e, o && (b = pn(c, T, o)), b = fn(c, b, T, l), l ? (c.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (x.lastModified[r] = w), w = T.getResponseHeader("etag"), w && (x.etag[r] = w)), 204 === e || "HEAD" === c.type ? C = "nocontent" : 304 === e ? C = "notmodified" : (C = b.state, m = b.data, y = b.error, l = !y)) : (y = C, (e || !C) && (C = "error", 0 > e && (e = 0))), T.status = e, T.statusText = (t || C) + "", l ? h.resolveWith(p, [m, C, T]) : h.rejectWith(p, [T, C, y]), T.statusCode(g), g = undefined, u && f.trigger(l ? "ajaxSuccess" : "ajaxError", [T, c, l ? m : y]), d.fireWith(p, [T, C]), u && (f.trigger("ajaxComplete", [T, c]), --x.active || x.event.trigger("ajaxStop")));
      }
      ...
      if (n = ln(on, c, t, T)) {
        T.readyState = 1, u && f.trigger("ajaxSend", [T, c]), c.async && c.timeout > 0 && (s = window["setTimeout"](function () {
          T.abort("timeout");
        }, c.timeout));
        try {
          v = 1, n.send(m, k);
  ...
  x.ajaxSetup({
    ...
    "contents": {
      "script": new window["RegExp"]("(?:java|ecma)script", "")
    },
    "converters": {
  ...
  var xn,
    bn,
    wn = new window["RegExp"]("^(?:toggle|show|hide)$", ""),
    Tn = window["RegExp"]("^(?:([+-])=|)(" + b + ")([a-z%]*)$", "i"),
    Cn = new window["RegExp"]("queueHooks$", ""),
    kn = [An],
    Nn = {
      "*": [function (e, t) {
  ...
  x.each({
    ...
    "swing": function (e) {
      return .5 - window["Math"].cos(e * window["Math"].PI) / 2;
    }
    ...
    bn || (bn = window["setInterval"](x.fx.tick, x.fx.interval));
  }, x.fx.stop = function () {
    window["clearInterval"](bn), bn = null;
  }, x.fx.speeds = {
    "slow": 600,
    "fast": 200,
    "_default": 400
    ...
    "setOffset": function (e, t, n) {
      var r,
        ...
        p = x(e),
        f = {};
      "static" === c && (e.style.position = "relative"), a = p.offset(), o = x.css(e, "top"), u = x.css(e, "left"), l = ("absolute" === c || "fixed" === c) && (o + u).indexOf("auto") > -1, l ? (r = p.position(), s = r.top, i = r.left) : (s = window["parseFloat"](o) || 0, i = window["parseFloat"](u) || 0), x.isFunction(t) && (t = t.call(e, n, a)), null != t.top && (f.top = t.top - a.top + s), null != t.left && (f.left = t.left - a.left + i), "using" in t ? t.using.call(e, f) : p.css(f);
    }
  }, x.fn.extend({
    "position": function () {
      if (this[0]) {
    ...
    x.each({
      ...
      x.fn[r] = function (r, i) {
        ...
        return x.access(this, function (t, n, r) {
          var i;
          return x.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (i = t.documentElement, window["Math"].max(t.body["scroll" + e], i["scroll" + e], t.body["offset" + e], i["offset" + e], i["client" + e])) : r === undefined ? x.css(t, n, s) : x.style(t, n, r, s);
...
//             var ret = target[p];
//             console.log("target ->", target, ", p ->", p, ", ret ->", ret);
//             // if (p == "cache"){
//             //     window.iii++;
//             //     if (window.iii > 48){
//             //         debugger;
